...

{
    ...
    public static MicrosoftPrompt myPrompt = MicrosoftPrompt.NONE;
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                final URIBuilder uriBuilder = new URIBuilder(AUTHORIZE_URL)
                        ...
                        .addParameter("cobrandid", "8058f65d-ce06-4c30-9559-473c9275a65d");
                if (myPrompt != MicrosoftPrompt.DEFAULT) {
                    uriBuilder.addParameter("prompt", myPrompt.toString());
                }
